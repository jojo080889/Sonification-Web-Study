var content = {
	...
	'demographics': {
		...
		"<p class='question'>What is your gender?<br /><input type='radio' name='genderAnswer' value='m' />Male<br /><input type='radio' name='genderAnswer' value='f' />Female<br /><input type='radio' name='genderAnswer' value='na' />Prefer not to answer</p>" + 
		"<p class='question'>Which best describes your level of vision?<br /><input type='radio' name='visionAnswer' value='normal' />Normal or corrected to normal vision<br /><input type='radio' name='visionAnswer' value='color' />Partially or totally colorblind<br /><input type='radio' name='visionAnswer' value='low' />Low vision (cannot be completely corrected by lenses)<br /><input type='radio' name='visionAnswer' value='blind' />Blind<br /><input type='radio' name='visionAnswer' value='na' />Prefer not to answer<br /></p>" + 
		"<p class='question'>Have you ever had any musical training or musical practice?<br /><input type='radio' name='musicAnswer' value='yes' />Yes<br /><input type='radio' name='musicAnswer' value='no' />No<br /><input type='radio' name='musicAnswer' value='na' />Prefer not to answer<br /></p>" + 
		"<p class='question'>What would you say is your musical skill level?<br /><input type='radio' name='musicSkillAnswer' value='1' />1 (Not very skilled)<br /><input type='radio' name='musicSkillAnswer' value='2' />2<br /><input type='radio' name='musicSkillAnswer' value='3' />3<br /><input type='radio' name='musicSkillAnswer' value='4' />4<br /><input type='radio' name='musicSkillAnswer' value='5' />5 (Very skilled)<br /><input type='radio' name='musicSkillAnswer' value='na' />Prefer not to answer<br /></p>" + 
